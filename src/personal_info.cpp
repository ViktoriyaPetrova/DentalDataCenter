...
//Check that the state contains only valid characters. If the string contains anything other than
//"A-Z" or "a-z" it will return false. If the string is not exactly 2 characters it will return false.
